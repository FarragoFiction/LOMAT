...
void main() {
  String flavorTown = "You arrive in beautiful INSERTNAMEHERE, the jewel of LOMAT. <br><Br>Or at least that's what you'd think if it were in its finished state. Sadly, it appears to have been shittly drawn by a WASTE or something, and everything in it is in test mode and half finished. <br><Br>Oh well, beats looking at a blank white screen, you suppose.";
  town = new Town("city2",<LOMATNPC>[LOMATNPC.generateRandomNPC(1),LOMATNPC.generateRandomNPC(2),LOMATNPC.generateRandomNPC(3)],null)..introductionText = flavorTown;
