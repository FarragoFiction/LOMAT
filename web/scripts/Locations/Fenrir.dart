...
class Fenrir {
    ...
    static void printText(Element container){
        ...
        DivElement heir = new DivElement()..setInnerHtml("<h1>Inheritance</h1><img src = 'images/ButlerPanel.png'><br>$ht<br><img src = 'images/SadButler.png'>", treeSanitizer: NodeTreeSanitizer.trusted)..classes.add("story");
